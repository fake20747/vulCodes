...
/*public class main {
		...
		{
			System.out.println("Program started fine !!!");
			...
			System.out.println("Program ended fine !!!");
		}
...
public class main {
    ...
    static void printBoard(KeyPairGenerator robustKeyPairGen1)
    {
    	robustKeyPairGen1.initialize(1024);
        System.out.println("|---|---|---|");
